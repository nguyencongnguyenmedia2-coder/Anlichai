...
export const AI_PROVIDER_PRESETS: Record<string, {
  name: string;
  baseUrl: string;
  defaultModel: string;
  requiresKey: boolean;
  ...
  deepseek: {
    ...
    requiresKey: true,
    hintKey: 'sk-... (Lấy tại platform.deepseek.com)',
  ...
  openai: {
    ...
    requiresKey: true,
    hintKey: 'sk-proj-... (Lấy tại platform.openai.com)',
  ...
  claude: {
    ...
    requiresKey: true,
    hintKey: 'sk-ant-... (Lấy tại console.anthropic.com)',
  ...
  kimi: {
    ...
    requiresKey: true,
    hintKey: 'sk-... (Lấy tại platform.moonshot.cn)',
  ...
  local: {
    ...
    defaultModel: 'llama3',
    requiresKey: false,
    hintKey: 'Tùy chọn (Ollama/LM Studio trên máy không cần key)',
    models: ['llama3', 'llama3.1', 'qwen2.5', 'deepseek-r1', 'mistral', 'gemma2'],
  },
  custom: {
    name: 'Custom / Proxy API (ZenMux, OpenRouter, vLLM...)',
    baseUrl: import.meta.env.VITE_ZENMUX_BASE_URL || 'https://zenmux.ai/api/v1',
    defaultModel: import.meta.env.VITE_ZENMUX_MODEL || 'deepseek/deepseek-v4-flash-vision-exp-free',
    requiresKey: true,
    hintKey: 'API Key máy chủ tùy chỉnh',
    models: ['deepseek/deepseek-v4-flash-vision-exp-free', 'custom-model'],
  },
};
