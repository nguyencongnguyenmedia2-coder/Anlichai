...
export const PersonalEventModal: React.FC<PersonalEventModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-xs">
      <div className="bg-white dark:bg-oriental-dark-card rounded-2xl max-w-lg w-full p-5 sm:p-6 shadow-2xl border border-amber-200 dark:border-oriental-dark-border relative max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center space-x-2.5 mb-5">
          <div className="p-2 rounded-xl bg-oriental-red-800 text-oriental-gold-300 shadow-oriental text-xl">
            🗓️
          </div>
          <div>
            ...
            <p className="text-xs text-amber-900/70 dark:text-amber-200/60">
              Hỗ trợ nhắc nhở theo Lịch Âm & Lịch Dương chuẩn xác
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs sm:text-sm">
          ...
          {/* Title Input */}
          <div>
            <label className="block font-semibold text-slate-700 dark:text-amber-200 mb-1">
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 bg-amber-50/50 dark:bg-oriental-dark-bg border border-amber-300 dark:border-amber-800 rounded-xl text-slate-800 dark:text-amber-100 focus:outline-none focus:ring-2 focus:ring-oriental-gold-500 font-medium"
            />
          </div>

          {/* Category Selector Grid */}
          <div>
            <label className="block font-semibold text-slate-700 dark:text-amber-200 mb-1.5">
              Phân Loại Sự Kiện
            </label>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-1.5 max-h-36 overflow-y-auto no-scrollbar p-1 bg-amber-50/40 dark:bg-oriental-dark-bg/60 rounded-xl border border-amber-200/60">
              {(Object.keys(CATEGORY_CONFIG) as PersonalEventType[]).map((catKey) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center space-x-1.5 px-2.5 py-1.5 rounded-lg text-xs font-semibold text-left transition-all ${
                      selected
                        ? 'bg-oriental-red-800 text-oriental-gold-300 shadow-xs border border-oriental-gold-500/40'
                        : 'bg-white dark:bg-oriental-dark-card text-slate-700 dark:text-amber-200/80 hover:bg-amber-100'
                    }`}
                  >
                    <span>{cfg.icon}</span>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className={`py-2 px-3 rounded-xl border font-bold text-xs flex items-center justify-center space-x-2 transition-all ${
                  isLunar
              ...
              >
                ...
                {isLunar && <Check className="w-3.5 h-3.5" />}
              </button>
          ...
          <div className="grid grid-cols-3 gap-2">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-amber-50/50 dark:bg-oriental-dark-bg border border-amber-300 dark:border-amber-800 rounded-xl text-slate-800 dark:text-amber-100 font-bold"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-2 py-1.5 bg-amber-50/50 dark:bg-oriental-dark-bg border border-amber-300 dark:border-amber-800 rounded-xl text-slate-800 dark:text-amber-100 font-medium"
              />
            </div>
          </div>
          ...
          <div>
            <label className="block font-semibold text-slate-700 dark:text-amber-200 mb-1 flex items-center gap-1">
                ...
                <button
                  ...
                  className={`py-1.5 px-2 rounded-xl text-xs font-semibold border transition-all ${
                    remindBeforeDays === r.days
                      ...
                      : 'bg-amber-50/50 dark:bg-oriental-dark-bg text-slate-700 dark:text-slate-300 border-amber-200 dark:border-amber-800'
                  }`}
                >
                  {r.label}
                </button>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 bg-amber-50/50 dark:bg-oriental-dark-bg border border-amber-300 dark:border-amber-800 rounded-xl text-slate-800 dark:text-amber-100 focus:outline-none focus:ring-2 focus:ring-oriental-gold-500 text-xs"
            />
          </div>

          {/* Notify Switch */}
          <div className="flex items-center justify-between pt-1 bg-amber-50/40 dark:bg-oriental-dark-bg/40 p-2.5 rounded-xl border border-amber-200/50">
            <span className="font-semibold text-xs text-slate-700 dark:text-amber-200 flex items-center gap-1.5">
              <Bell className="w-3.5 h-3.5 text-amber-600" />
          ...
          <div className="pt-3 flex justify-end space-x-2 border-t border-amber-200/60 dark:border-oriental-dark-border">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 bg-slate-200 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-xl font-medium text-xs hover:bg-slate-300"
            >
              Hủy Bỏ
            </button>
            <button
              type="submit"
              className="px-5 py-2 bg-oriental-red-800 hover:bg-oriental-red-900 text-oriental-gold-300 font-bold rounded-xl shadow-oriental transition-all flex items-center space-x-1.5 border border-oriental-gold-500/40 text-xs"
            >
