...
import { Search, Plus, Trash2, Flag } from 'lucide-react';
          ...
          >
            <div>
              ...
              <div className="flex items-center justify-between mb-2.5">
                ...
                <span className="font-serif font-bold text-xs px-3 py-0.5 rounded-full bg-amber-100 dark:bg-amber-900/40 text-oriental-red-900 dark:text-oriental-gold-300 border border-amber-300/50">
                  {ev.isLunar
                    ? `🌙 Mùng ${ev.lunarDay}/${ev.lunarMonth} Âm`
                    : `☀️ Ngày ${ev.solarDay}/${ev.solarMonth} Dương`}
                </span>
              </div>

              {/* Event Name */}
              <h3 className="font-serif font-extrabold text-base sm:text-lg text-oriental-red-900 dark:text-oriental-gold-300 mb-2 leading-snug">
                {ev.name}
              </h3>
            ...
            {isAdminMode && (
              <div className="pt-2.5 mt-3 border-t border-amber-200/50 dark:border-amber-900/40 flex justify-end">
                <button
